<template>
  <div class="login" :class="'switch-' + mode">
    <div v-if="mode == 'login'">
      <div class="mb-3 row">
        <p>Logowanie</p>
    ...
    <div v-if="mode == 'registration'">
      <p>Rejestracja</p>
      <div class="mb-3 row">
        <label for="staticName" class="col-sm-2 col-form-label">Nazwa</label>
        <div class="col-sm-10">
      ...
      <div class="mb-3 row">
        ...
        >
        <div class="col-sm-9">
          <input :type="passwordMode" class="form-control" id="inputPassword" />
        </div>
        <div class="col-sm-1">
          <button
            type="button"
